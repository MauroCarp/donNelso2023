                            ...
                            <div class='row'>
                                ...
                                <div class="col-lg-12">
                                        ...
                                        <label style="font-size:2em;">
                                            <input type="radio" name="animalServicio" class="hide animalServicio" value="cerdo" checked/>
                                            <i class="icon icon-cerdo"></i>
                                        </label>
                
                                        <label style="font-size:2em;">
                                            <input type="radio" name="animalServicio" class="hide animalServicio" value="chivo"/>
                                            <i class="icon icon-chivo"></i>
                                        </label>
                
                                        <label style="font-size:2em;">
                                            <input type="radio" name="animalServicio" class="hide animalServicio" value="ovino"/>
                                            <i class="icon icon-cordero"></i>
                                        </label>

                                        <label style="font-size:2em;">
                                            <input type="radio" name="animalServicio" class="hide animalServicio" value="vaca"/>
