...
const generarItem = (leyendaText,dato,machos)=>{
    ...
    if(hembraValido !== -1){
        ...
        buttonServir.setAttribute('onclick',`accionBtnServir('${tipo}','${dato}','Servir',this)`)
...
const generarRodeo = (props)=>{
    ...
    btnEliminarRodeo.setAttribute('onclick','eliminarRodeo(this.getAttribute("idRodeo"),this.getAttribute("tipo"),this)')
...
const accionBtnServir = (tipo,caravana,textButton,evt)=>{
...
const servirHembra = (props)=>{
    ...
    $.ajax({
        ...
        success:function(response){
            ...
            props.evt.innerText = 'Cancelar Servicio'

            if(props.textButton == 'Servir'){

                props.evt.setAttribute('onclick',`accionBtnServir('${props.tipo}','${props.caravana}','Cancelar Servicio',this)`)
                
            }else{
                
                props.evt.setAttribute('onclick',`accionBtnServir('${props.tipo}','${props.caravana}','Servir',this)`)
    ...
    $.ajax({
        ...
        success:(response)=>{
            ...
            if(respuesta.servicioValido == 1){
                ...
                button.setAttribute('onclick',`accionBtnServir('${button.getAttribute('tipo')}','${button.getAttribute('caravana')}','Cancelar Servicio',this)`)
...
// ELIMINAR RODEO
const eliminarRodeo = (idRodeo,tipo)=>{
